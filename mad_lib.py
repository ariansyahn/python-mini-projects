...
def main():
    ...
    location = input('Enter a location (e.g., Maine or Playground) : ')
    ...
    mad_lib = story.format(command, command, plural_noun, location, animal,
                           adjectives[0], adjectives[1], singular_noun, past_participles[0], past_participles[1])
